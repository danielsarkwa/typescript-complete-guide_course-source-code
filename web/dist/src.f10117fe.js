...
function () {
  ...
  Object.defineProperty(Model.prototype, "on", {
    /*
      these are an accessor whicj returns the function and does not invoke it
  ...
  Object.defineProperty(Model.prototype, "tigger", {
    get: function get() {
  ...
  Model.prototype.fetch = function () {
    ...
    this.sync.fetch(id).then(function (reponse) {
...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      var eventHandlers = _this.events[eventName] || [];
      eventHandlers.push(callback);
      _this.events[eventName] = eventHandlers;
    };
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attribute":"src/models/Attribute.ts","./Eventing":"src/models/Eventing.ts","./ApiSync":"src/models/ApiSync.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
collection.fetch();
},{"./models/User":"src/models/User.ts"}],"C:/Users/HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
